...
- Remove importFrom utils. [Giuseppe Acito]
- Remove importFrom rprogressbar. [Giuseppe Acito]
- Remove rredis. [Giuseppe Acito]
- Remove importFrom stringr. [Giuseppe Acito]
- Fix dangling " [Giuseppe Acito]
- Fix dangling keys,values. [Giuseppe Acito]
- Fix dangling keys. [Giuseppe Acito]
- Removed hash. [Giuseppe Acito]
- Fix typo. [Giuseppe Acito]
- Patch for as.dataset S4 generic. [Giuseppe Acito]
- Fix typo. [Giuseppe Acito]
- Still refactoring imports. [Giuseppe Acito]
- Remove importFrom rdataset. [Giuseppe Acito]
- Removed importFrom crayon. [Giuseppe Acito]
- Removed importFrom formatR. [Giuseppe Acito]
- Remove importFrom gdata. [Giuseppe Acito]
- Removed importFrom jsonlite. [Giuseppe Acito]
- Remove importFrom progress. [Giuseppe Acito]
- Removed importFrom rutils. [Giuseppe Acito]
- Removed importFrom iterators. [Giuseppe Acito]
- Partially removed foreach. [Giuseppe Acito]
- Removed unused dep, R.utils. [Giuseppe Acito]
- Remove importFrom hash. [Giuseppe Acito]
- Remove importFrom stringr. [Giuseppe Acito]
...
- Fix typo. [Giuseppe Acito]
- Fix remove plot. [Giuseppe Acito]
- Remove implicit function calling. [Giuseppe Acito]
- Removing some imports. [Giuseppe Acito]
- Prepare for change. [Giuseppe Acito]
...
- Checks pass. [giupo]
- Forgot to snapshot!!! [Giuseppe Acito]
- Merge branch 'master' of https://osiride-gitlab-
  dev.utenze.bankit.it/m024000/GrafoDB. [Giuseppe Acito]
- Update .gitlab-ci.yml: remove artifacts. [Giuseppe]
- Update renv with rdataset 0.5.2. [Giuseppe Acito]
