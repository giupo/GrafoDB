...
List workerFunction(string m_username, string m_password, 
                    string m_hostname, string m_port,
                    string m_dbname, vector<string> names, string tag) {
  List z = List::create();
  ...
  pqxx::work T(conn, "LoadData Transaction");
